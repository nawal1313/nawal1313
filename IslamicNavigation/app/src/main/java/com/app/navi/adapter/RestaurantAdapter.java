...
public abstract class RestaurantAdapter extends ArrayAdapter<String> {
    ...
    public RestaurantAdapter(Activity context, String[] itemname, Integer[] imgid, String[] hoteladdress, String[] hotelnumbers) {
