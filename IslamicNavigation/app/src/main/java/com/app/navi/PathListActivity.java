...
import com.app.navi.adapter.PathListAdapter;
...
public class PathListActivity extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        final PathListAdapter adapter = new PathListAdapter(viewModel, new PathListAdapter.PathDiff()) {
        ...
        viewModel.getAllPaths().observe(this, words -> {
